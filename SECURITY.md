...
- **Platform-agnostic IPC** via `biomeos-core::ipc` (`TransportStream`, `TransportListener`) — Unix primary, TCP fallback on Windows; Neural API routing (Phase 3 / Wave 157a)
