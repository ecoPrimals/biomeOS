...
use biomeos_spore::manifest::{BinaryManifest, BinaryInfo, SporeManifest, ManifestMeta, CompatibilityInfo};
use chrono::Utc;
...
fn test_binary_manifest_serialization() {
    ...
    binaries.insert("beardog".to_string(), BinaryInfo {
...
fn test_spore_manifest_genetic_lineage() {
    ...
    assert_ne!(manifest.lineage.parent_seed_hash, manifest.lineage.child_seed_hash);
}
