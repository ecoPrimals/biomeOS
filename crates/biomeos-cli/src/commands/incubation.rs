...
pub async fn handle_spore_incubate(args: &IncubateArgs) -> Result<()> {
    ...
    println!("  Incubated At:      {}", incubated.incubated_at.to_rfc3339());
    println!("  Entropy Hash:      {}...", &incubated.entropy_hash[..16]);
    println!("  Deployed Seed:     {}...", &incubated.deployed_seed_hash[..16]);
    println!("  Config Path:       {}", incubated.local_config_path.display());
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
...
pub async fn handle_node_list_local(args: &ListLocalArgs) -> Result<()> {
    ...
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!("{:<25} {:<25} {:<30} {:<20}", "NODE_ID", "SPORE_ID", "DEPLOYED_AT", "FAMILY_ID");
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    ...
    for node in &filtered {
        println!(
            ...
            node.node.deployed_at.format("%Y-%m-%d %H:%M:%S").to_string(),
        ...
        if args.detailed {
            ...
            println!("  Deployed Seed:    {}...", &node.lineage.deployed_seed_hash[..16]);
            ...
            if !node.federation.sub_federations.is_empty() {
                println!("  Sub-Federations:  {}", node.federation.sub_federations.join(", "));
            }
