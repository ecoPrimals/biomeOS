...
pub fn templates_json() -> Value {
    let templates: Vec<Value> = BUILTIN_TEMPLATES.iter().map(NicheTemplate::to_json).collect();
    json!(templates)
}
...
pub static BUILTIN_TEMPLATES: &[NicheTemplate] = &[
    ...
    NicheTemplate {
        ...
        storage_gb: 10,
        parameters: &[
            NicheParam { name: "SESSION_ID", param_type: "string", required: Some(true), description: Some("Provenance session to commit"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for signing"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        ...
        storage_gb: 5,
        parameters: &[
            NicheParam { name: "SESSION_ID", param_type: "string", required: Some(true), description: Some("Provenance session to dehydrate"), default_value: None, values: None },
            NicheParam { name: "EXPERIMENT_ID", param_type: "string", required: Some(true), description: Some("Experiment identifier"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for signing"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        ...
        storage_gb: 5,
        parameters: &[
            NicheParam { name: "PARENT_COMMIT_ID", param_type: "string", required: Some(true), description: Some("Commit to branch from"), default_value: None, values: None },
            NicheParam { name: "BRANCH_NAME", param_type: "string", required: Some(true), description: Some("Name for the new branch"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for attribution"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        id: "rootpulse-merge",
        ...
        storage_gb: 5,
        parameters: &[
            NicheParam { name: "SOURCE_SPINE_ID", param_type: "string", required: Some(true), description: Some("Branch spine to merge from"), default_value: None, values: None },
            NicheParam { name: "TARGET_SPINE_ID", param_type: "string", required: Some(true), description: Some("Target spine to merge into"), default_value: None, values: None },
            NicheParam { name: "SOURCE_SESSION_ID", param_type: "string", required: Some(true), description: Some("Provenance session for source"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for attribution"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        ...
        storage_gb: 1,
        parameters: &[
            NicheParam { name: "COMMIT_A", param_type: "string", required: Some(true), description: Some("First commit to compare"), default_value: None, values: None },
            NicheParam { name: "COMMIT_B", param_type: "string", required: Some(true), description: Some("Second commit to compare"), default_value: None, values: None },
            NicheParam { name: "SESSION_A", param_type: "string", required: Some(true), description: Some("Provenance session for commit A"), default_value: None, values: None },
            NicheParam { name: "SESSION_B", param_type: "string", required: Some(true), description: Some("Provenance session for commit B"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        ...
        storage_gb: 5,
        parameters: &[
            NicheParam { name: "SPINE_ID", param_type: "string", required: Some(true), description: Some("Spine to synchronize"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for attribution"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
        ...
        parameters: &[
            NicheParam { name: "EXPERIMENT_ID", param_type: "string", required: Some(true), description: Some("Experiment identifier"), default_value: None, values: None },
            NicheParam { name: "AGENT_DID", param_type: "string", required: Some(false), description: Some("Agent DID for provenance"), default_value: None, values: None },
        ],
    },
    NicheTemplate {
