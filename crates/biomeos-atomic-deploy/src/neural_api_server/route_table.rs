...
pub(super) enum Route {
    ...
    CompositionStatus,
    CompositionStart,
    CompositionOrchestrate,
    CompositionBootOrder,
    DeployResultEmit,
    CompositionDeploy,
...
const ROUTE_TABLE: &[(&str, Route)] = &[
    ...
    ("composition.nest_health", Route::NestHealth),
    ("nest.health", Route::NestHealth),
    ("nest.capabilities", Route::NestCapabilities),
    ...
    ("neural_api.training_data", Route::TrainingDataDrain),
    ...
    ("composition.start", Route::CompositionStart),
    ("composition.orchestrate", Route::CompositionOrchestrate),
    ("composition.boot_order", Route::CompositionBootOrder),
    ("deploy.result", Route::DeployResultEmit),
    ("composition.deploy", Route::CompositionDeploy),
    ("composition.self_test", Route::CompositionSelfTest),
    ("composition.test_swap", Route::CompositionTestSwap),
    ...
    // Tower Atomic (security + discovery + defense)
    ...
    ("tower.enroll", Route::SemanticCapabilityCall),
    ("tower.mesh_status", Route::SemanticCapabilityCall),
    ("tower.key_rotate", Route::SemanticCapabilityCall),
    // Node Atomic (Tower + compute substrate)
    ("node.compute", Route::SemanticCapabilityCall),
    ("node.discover_hardware", Route::SemanticCapabilityCall),
    ("node.dispatch", Route::SemanticCapabilityCall),
    // Nest Atomic (Tower + storage + provenance)
    ...
    ("nest.verify", Route::SemanticCapabilityCall),
    ("nest.federate", Route::SemanticCapabilityCall),
    ("nest.ingest_spore", Route::SemanticCapabilityCall),
    ("nest.emit_spore", Route::SemanticCapabilityCall),
    // Nest content surface (nestGate UDS/HTTP/tarpc)
    ("content.put", Route::SemanticCapabilityCall),
    ("content.get", Route::SemanticCapabilityCall),
    ("content.exists", Route::SemanticCapabilityCall),
    ("content.list", Route::SemanticCapabilityCall),
    ("content.stat", Route::SemanticCapabilityCall),
    ("content.ingest", Route::SemanticCapabilityCall),
    ("content.fetch", Route::SemanticCapabilityCall),
    // DAG domain (rhizoCrypt — rootPulse graph steps)
    ("dag.session.create", Route::SemanticCapabilityCall),
    ("dag.dehydration.trigger", Route::SemanticCapabilityCall),
    ("dag.merkle.root", Route::SemanticCapabilityCall),
    ("dag.vertex.get", Route::SemanticCapabilityCall),
    ("dag.event.append", Route::SemanticCapabilityCall),
    // Spine/commit domain (loamSpine — rootPulse graph steps)
    ("spine.create", Route::SemanticCapabilityCall),
    ("spine.get", Route::SemanticCapabilityCall),
    ("spine.seal", Route::SemanticCapabilityCall),
    ("entry.append", Route::SemanticCapabilityCall),
    ("entry.get", Route::SemanticCapabilityCall),
    ("session.commit", Route::SemanticCapabilityCall),
    ("session.state", Route::SemanticCapabilityCall),
    // Attribution domain (sweetGrass — rootPulse graph steps)
    ("braid.create", Route::SemanticCapabilityCall),
    ("braid.verify", Route::SemanticCapabilityCall),
    ("braid.query", Route::SemanticCapabilityCall),
