    ...
    let domain_providers: &[DomainProvider] = &[
        ...
        (
            ...
            &[
                ...
                ("discovery.peers", "discovery.list_peers"),
                ("discovery.list_peers", "discovery.list_peers"),
        ...
        (
            ...
            &[
                ...
                ("dag.dehydration.trigger", "dag.dehydration.trigger"),
                ...
                ("dag.event.append_batch", "dag.event.append_batch"),
        ...
        (
            ...
            &[
                ...
                ("spine.status", "spine.status"),
                ("spine.append", "commit.append"),
                ("entry.append", "entry.append"),
                ("entry.get", "entry.get"),
                ("entry.get_tip", "entry.get_tip"),
        ...
        (
            ...
            &[
                ...
                ("braid.get", "braid.get"),
                ("braid.verify", "braid.verify"),
                ("braid.list", "braid.list"),
                ("braid.query", "braid.query"),
            ],
        ),
