...
mod unit_tests {
    ...
    async fn test_mock_primal_adapter_creation() {
        let adapter =
            MockPrimalAdapter::new("test_primal", vec!["test".to_string(), "mock".to_string()]);
...
mod integration_tests {
    ...
    async fn test_multiple_primal_registration() -> Result<()> {
        ...
        let primals = vec![
            (
                "songbird",
                vec!["orchestration".to_string(), "coordination".to_string()],
            ),
    ...
    async fn test_health_check_command() -> Result<()> {
        ...
        ui_manager
            .register_primal("healthy_primal", adapter)
            .await?;
    ...
    async fn test_deployment_command() -> Result<()> {
        ...
        ui_manager
            .register_primal("deployment_primal", adapter)
            .await?;
    ...
    async fn test_service_scaling() -> Result<()> {
        ...
        ui_manager
            .register_primal("scaling_primal", adapter)
            .await?;
    ...
    async fn test_log_retrieval() -> Result<()> {
        ...
        ui_manager
            .register_primal("logging_primal", adapter)
            .await?;
    ...
    async fn test_metrics_retrieval() -> Result<()> {
        ...
        ui_manager
            .register_primal("metrics_primal", adapter)
            .await?;
...
mod e2e_tests {
    ...
    async fn test_concurrent_operations() -> Result<()> {
        ...
        for i in 0..5 {
            let adapter =
                MockPrimalAdapter::new(&format!("primal_{}", i), vec!["test".to_string()]);
            ui_manager
                .register_primal(&format!("primal_{}", i), adapter)
                .await?;
        }
        ...
        for handle in handles {
            ...
            assert!(result.is_ok() || result.is_err()); // Either success or handled error
        }
    ...
    async fn test_performance_under_load() -> Result<()> {
        ...
        ui_manager
            .register_primal("load_test_primal", adapter)
            .await?;
...
mod performance_tests {
    ...
    async fn test_memory_usage_with_many_primals() -> Result<()> {
        ...
        for i in 0..50 {
            let adapter =
                MockPrimalAdapter::new(&format!("primal_{}", i), vec![format!("capability_{}", i)]);
            ui_manager
                .register_primal(&format!("primal_{}", i), adapter)
                .await?;
        }
    ...
    async fn test_concurrent_request_handling() -> Result<()> {
        ...
        ui_manager
            .register_primal("concurrent_test", adapter)
            .await?;
        ...
        println!(
            "Handled {} concurrent requests in {:?}",
...
mod edge_case_tests {
    ...
    async fn test_duplicate_primal_registration() -> Result<()> {
        ...
        ui_manager
            .register_primal("duplicate_primal", adapter1)
            .await?;

        // Second registration should replace the first
        let result = ui_manager
            .register_primal("duplicate_primal", adapter2)
            .await;
        assert!(result.is_ok());
