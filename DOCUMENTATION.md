...
| See evolution handoffs (v2.43–v3.83) | [wateringHole/handoffs/](../../infra/wateringHole/handoffs/) |
...
# Test (8,053 tests — fully concurrent)
...
**Documentation current as of May 27, 2026 (v3.83)**
**Active: 26 specs, handoffs in wateringHole (v2.43–v3.83), 4 scripts**
