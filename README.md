...
| Tests | 7,658 passing (0 failures, 0 ignored, fully concurrent) — 90%+ line / function / region (llvm-cov) |
| Unsafe Code | 0 in production (workspace `deny`, `#[forbid(unsafe_code)]` on all crate roots including CLI bin) |
...
**Tests**: 7,658 passing (0 ignored), 90%+ line / function / region (llvm-cov) | **Clippy**: pedantic+nursery, `-D warnings` | **Docs**: Full coverage | **Format**: PASS | **C deps**: 0 | **Unsafe**: 0 | **Deprecated**: 0 | **Blocking debt**: 0
