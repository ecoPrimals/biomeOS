...
| TODO/FIXME/HACK | 0 active (all resolved in v3.80) |
...
|--------|-------|-------|---------|
| **Release train** | `v3.80` | README, CHANGELOG, git tags | Tracks evolution waves visible to downstream consumers. Incremented on each audit/evolution cycle. |
