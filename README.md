...
| Tests | 8,522+ workspace-wide, 0 regressions, fully concurrent — 88.37% line / 89.58% function (llvm-cov) |
...
**Tests**: 8,522+ workspace-wide (0 regressions), 88%+ line / function (llvm-cov) | **Clippy**: pedantic+nursery, 0 warnings (incl tests) | **Docs**: Full coverage | **Format**: PASS | **C deps**: 0 | **Unsafe**: 0 (all 26 crates `#![forbid(unsafe_code)]`) | **Deprecated**: 0 | **Blocking debt**: 0
