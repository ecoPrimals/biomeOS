...
| Tests | 7,192 passing (0 failures) — 90%+ coverage (llvm-cov verified) |
...
**Tests**: 7,192 passing, 90%+ coverage (llvm-cov verified) | **Clippy**: PASS (0 warnings, pedantic+nursery) | **Docs**: Full coverage | **Format**: PASS | **C deps**: 0 | **Unsafe**: 0 production
