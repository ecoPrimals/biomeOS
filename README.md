...
|--------|-------|-------|---------|
| **Release train** | `v3.63` | README, CHANGELOG, git tags | Tracks evolution waves visible to downstream consumers. Incremented on each audit/evolution cycle. |
