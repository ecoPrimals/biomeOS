...
|--------|-------|-------|---------|
| **Release train** | `v4.04` | README, CHANGELOG, git tags | Tracks evolution waves visible to downstream consumers. Incremented on each audit/evolution cycle. |
