        ...
        for niche in &config.included_niches {
            match niche.as_str() {
                "gaming-tournament" => {
                    ...
                    {
                        return Err(
                            "Gaming tournament niche requires Toadstool and Songbird primals"
                                .to_string(),
                        );
                    }
                }
                "ai-research" => {
                    ...
                    {
                        return Err(
                            "AI research niche requires Squirrel and NestGate primals".to_string()
                        );
                    }
                }
                "web-development" => {
