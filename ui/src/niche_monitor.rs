...
use std::fs;
use std::path::Path;
use crate::views::niche_manager::{NichePackage, NicheTemplate, MarketplaceNiche, NicheCategory, NicheDifficulty, NicheStatus};
    ...
    fn detect_running_niches(&self) -> Vec<NichePackage> {
                ...
                if line.contains("biomeos-niche") {
                    ...
                    if parts.len() >= 2 {
                        ...
                        niches.push(NichePackage {
                            ...
                            manifest_path: format!("/var/lib/biomeos/niches/{}/niche.yaml", niche_name),
                            icon_path: None,
                            size_mb: 500,
                            downloads: 0,
                            rating: 4.0,
        ...
        if niches.is_empty() {
            niches.push(NichePackage {
                ...
                features: vec!["Dashboard".to_string(), "BYOB management".to_string(), "ISO creation".to_string()],
                requirements: Default::default(),
