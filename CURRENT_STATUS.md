...
**Updated**: April 6, 2026 (v2.90: primalSpring/wetSpring gap resolution — Neural API semantic method fallback (domain.operation routes through capability.call), provenance trio translations (dag/commit/attribution), composition health canonical namespace, 9 new composition health aliases)
**Version**: 2.90
