...
**Updated**: April 7, 2026 (v2.94: GAP-MATRIX second wave — GAP-07b proxy error propagation preserves primal JSON-RPC error codes, GAP-08 self-discovery pollution eliminated via socket exclusion, GAP-02b graph.list unified with DeploymentGraph fallback parser)
**Version**: 2.94
