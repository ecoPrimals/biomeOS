...
**Updated**: April 22, 2026 (v3.24: `primal.list` on neural-api + API socket, `rpc_call` operation fallback fix for graph node execution, `init_sovereign_onion` bootstrap tolerance, deep debt audit CLEAN; 7,814+ tests)
**Version**: 3.24
