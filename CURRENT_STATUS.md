...
**Updated**: April 7, 2026 (v2.93: GAP-MATRIX resolution — GAP-07 critical proxy forwarding fixed (unix:// URI scheme in TransportEndpoint::parse), GAP-01b Format E capability parser for BearDog provided_capabilities wire format, GAP-02 DeploymentGraph name/version made optional for TOML tolerance)
**Version**: 2.93
...
| **Tests Passing** | 7,654 lib + bin + doc + proptest (0 failures, 0 ignored, fully concurrent) |
